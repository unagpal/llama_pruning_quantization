...
# Load Llama nf4 quantized model from local file system
...
# Load Llama int8 quantized model from local file system
...
#Load Llama bf16 model from local file system
def load_model_bf16():
